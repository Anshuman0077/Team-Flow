    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="icon"
          className={cn(
            "size-12 rounded-xl hover:rounded-lg transition-all duration-200 bg-background/50 border-border/50 hover:bg-accent hover:text-accent-foreground",
            className
          )}
        >
      ...
      >
        ...
        <DropdownMenuItem
          asChild
          className="flex items-center gap-3 px-3 py-2.5 cursor-pointer text-red-600 hover:bg-red-50 hover:text-red-700"
        >
          <LogoutLink>
