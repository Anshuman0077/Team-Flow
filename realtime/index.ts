...
import { ChannelEventSchema, PresenceMessageSchema, ThreadEventsSchema, UserSchema } from "@/app/(dashboard)/schemas/realtime";
...
export class Chat extends Server {
  ...
  onMessage(connection: Connection, message: string) {
    try {
        ...
        // Thread events
        const threadEvent = ThreadEventsSchema.safeParse(parsed)
